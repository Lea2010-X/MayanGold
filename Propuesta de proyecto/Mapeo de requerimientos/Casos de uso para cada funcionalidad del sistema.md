| CU-001                  |      | Menu Principal                                                                                                                                                               |
|-------------------------|------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Actor                   |      | Jugador Principal                                                                                                                                                            |
| Precondición            |      | El jugador ya ha iniciado el programa                                                                                                                                        |
| Secuencia Normal        | Paso | Acción                                                                                                                                                                       |
|                         | 1    | El jugador inicia el sistema                                                                                                                                                 |
|                         | 2    | Se muestran las opciones del menú:” Instrucciones”,” Entrar al casino”, “Minijuegos”, “Estadísticas”, “Tienda virtual”, "cargar/guardar progreso", y "Salir".                |
...
| Cuarta ruta de acción   | 6    | El usuario ingresa en "Estadisticas".                                                                                                                                        |
...
| octava ruta de acción   | 10   | El jugador escribe una opción que no esta en el menú                                                                                                                         |
...
| Primera ruta de acción | 2     | El usuario ingresa a "Blackjack"                                                                                                                     |
...
|-------------------------|-------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| Actor                   |       | Jugador Principal                                                                                                                                 |
| Descripción             |       | El jugador puede cargar/guardar progreso                                                                                                          |
| Precondición            |       | El jugador ha accedido a esta opción en el menú principal                                                                                         |
| Secuencia Normal        | Paso  | Acción                                                                                                                                            |
...
| Quinta ruta de acción   | 5     |     El jugador   escribe una opción que no está en el menú.                                                                                       |
|                         | 5.1   | Se le muestra un mensaje de informándole que la opción puesta no está disponible en el menú.                                                      |
|                         | 5.2   | El usuario vuelve a ver el menú.                                                                                                                  |
